    ...
    @if ($books->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <a href="{{ route('books.index', ['book' => $books[0]->slug]) }}"
                    class="text-decoration-none btn btn-primary">View details</a>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            <div class="position-absolute px-3 py-2"
                                ...
                                <a href="{{ route('books.index', ['book' => $book->category->slug]) }}"
                            ...
                            <div style="width: 100%; height: 200px;">
                                ...
                                @if ($book->image)
                                    <img src="{{ asset('storage/' . $book->image) }}" alt="{{ $book->category->name }}"
                                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px 5px 0 0;">
                                @else
                                    <img src="{{ $url . $book->category->name . '.jpg' }}"
