...
<div class="col-12 col-lg-5 d-flex flex-row">
    <div class="img-wrapper col-3 col-lg-3 col-xl-4">
        @if ($offeredBook->image)
            <img src="{{ asset('storage/' . $offeredBook->image) }}" alt="...">
        @else
            <img src="{{ asset('img/' . $offeredBook->category->name) . '.jpg' }}" alt="...">
        @endif
    </div>
...
<div class="col-12 col-lg-5 d-flex flex-row">
    <div class="img-wrapper col-3 col-lg-3 col-xl-4">
        @if ($targetBook->image)
            <img src="{{ asset('storage/' . $targetBook->image) }}" alt="...">
        @else
            <img src="{{ asset('img/' . $targetBook->category->name) . '.jpg' }}" alt="...">
        @endif
    </div>
    <div class="card-info col-8 col-lg-8 col-xl-7 d-flex flex-column justify-content-between ms-4">
        <div>
